...
public class ProductController {
    ...
    public String saveProduct(@ModelAttribute("product") ProductDto productDto,
            ...
            @RequestParam("categoryId") Long categoryId, // Thêm số 6 categoryId
        ...
        try {
            ...
            // Nếu CategoryDto có thêm các thuộc tính khác, bạn cần set tương ứng

            productDto.setCategory(category); // Gán category vào productDto

            // Lưu productDto và hình ảnh
