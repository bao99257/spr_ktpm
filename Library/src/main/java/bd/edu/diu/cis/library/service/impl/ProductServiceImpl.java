...
public class ProductServiceImpl implements ProductService {
    ...
    public Product save(MultipartFile imageProduct, ProductDto productDto) {
        try {
            ...
            if (productDto.getCategory() != null) {
                ...
                category.setName(productDto.getCategory().getCategoryName());
                category.setDescription(productDto.getCategory().getCategoryDescription());
            }
            product.setCategory(productDto.getCategory() != null ? category : null);
            product.setSalePrice(productDto.getSalePrice());
            product.setCostPrice(productDto.getCostPrice());
            product.setCurrentQuantity(productDto.getCurrentQuantity());
            product.set_activated(true);
    ...
    public ProductDto getById(Long id) {
        ...
        productDto.setCategory(product.getCategory() != null ? new CategoryDto(
